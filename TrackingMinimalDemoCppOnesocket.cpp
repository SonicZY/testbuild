...
int main(int argc, char* argv[]) {
   ...
   // }
    ...
    remote_addr_gun.sin_addr.s_addr = inet_addr("192.168.1.223");
   ...
   // const std::string placementData = argv[2];
    ...
    //const std::string placementData = "AAAAAAAAAAAAAAAAAAAAAIAAAAAAAAAAAA"; 
      ...
      const std::string placementData_gun = "AAAAAAAAAAAAAAAAANsPyT8AAAAA2w9JQA";// "AAAAAAAAAAAAAAAAANsPyT8AAAAA2w9JQA";AAAAAAAAAAAAAAAAANsPyT8AAAAA2w_JPw
      //const std::string placementData = "AAAAAAAK1yO8BoGVPcK4sj3bD8k_AAAAAA";AAAAAAAAAAAAAAAAANsPyT_bD8k_AAAAAA   AAAAAAAAAAAAAAAAAAAAAADbD8k_AAAAAA
