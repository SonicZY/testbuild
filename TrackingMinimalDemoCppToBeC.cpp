                       ...
                       float delay=atof(Message.c_str());
                        ...
                        if (altTrackingCotask_head != nullptr) {
                            ...
                            if(blink){
                                ...
                                sendMessage["Head"]["stability"]["stage"] = 1;
                                sendMessage["Head"]["stability"]["Value"] = 0;
                            }
                        ...
                        if (altTrackingCotask_gun != nullptr) {
                            Antilatency::Alt::Tracking::State state = altTrackingCotask_gun.getExtrapolatedState(placement_gun,0.046f);
                            //Antilatency::Alt::Tracking::State state = altTrackingCotask_gun.getState(0.005f);
